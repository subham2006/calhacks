...
class ImageShapeUtil extends import_editor.BaseBoxShapeUtil {
  ...
  component(shape) {
    ...
    const { asset, url } = (0, import_useAsset.useAsset)({
      shapeId: shape.id,
    ...
    const crossOrigin = this.isAnimated(shape) ? "anonymous" : void 0;
  ...
  async toSvg(shape) {
    ...
    if (containerStyle.transform && crop) {
      ...
      const cropClipId = `cropClipPath_${(0, import_editor.sanitizeId)(shape.id)}`;
